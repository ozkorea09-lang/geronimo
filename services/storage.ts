...
const INITIAL_ABOUT: AboutPageData = {
  ...
  philosophy: {
    ...
    subtitle: "제로니모가 추구하는 3가지 가치",
    items: [
      { title: "Specialty Coffee", description: "상위 7% 이내의 최상급 원두만을 선별하여 전문 바리스타가 정성스럽게 추출합니다." },
      { title: "Master Bakery", description: "대한민국 제과기능장이 매일 아침 최고급 재료로 구워내는 건강한 빵입니다." },
      { title: "Premium Space", description: "높은 층고와 화려한 조명이 어우러진 드라마틱한 공간에서 진정한 휴식을 즐기세요." }
    ]
  },
  gallery: {
